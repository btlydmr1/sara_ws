...
class Navigation(Node):
    ...
    def __init__(self):
        ...
        # 60 saniyelik güvenlik beklemesi
        ...
        # Şimdilik simülasyonda kullanılacak hız
        self.speed = 2.0
        ...
        # Navigasyon döngüsü saniyede 10 kez çalışır
    ...
    def navigation_loop(self):
        ...
        if self.state == WAITING:
            ...
            # Hareketten 10 saniye önce buzzer uyarısı
            ...
            # 60 saniye tamamlanınca ileri harekete geç
            if elapsed >= 60.0:
                self.state = FORWARD

                self.get_logger().info(
                    '60 saniyelik güvenlik beklemesi tamamlandı. '
                    'FORWARD durumuna geçildi.'
                )

        elif self.state == FORWARD:

            # Mesafe artık /sara/distance topic'inden geliyor
            ...
            # Heading artık /sara/heading topic'inden geliyor
            ...
            if abs(self.heading - self.target_heading) <= 5.0:
                ...
                self.get_logger().info(
                    ...
                    'RETURNING durumuna geçildi.'
                )

        elif self.state == RETURNING:

            # Bu kısım hâlâ simülasyon amaçlı
            ...
            # Şimdilik simülasyonda doğrudan bitiriyoruz
            self.state = FINISHED
